...
<head>
    <meta charset="utf-8">
    <title>KaryaOne - One in our heart</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="https://htmlcodex.com/startup-company-website-template" class="btn btn-secondary text-light rounded-pill py-2 px-4 ms-3">register</a>
                </div>
            </nav>
            ...
            <div class="container-xxl py-5 hero-header mb-5">
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid" src="img/gambar2_-removebg-preview.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
